...
Logo: rounded 12px Soil square, three terraces (Clay / Sage / Terrace #5C7A62) and a Sand twin-peak mountain — main peak, saddle, lower spire — whose shadow face is hatched with fine lines cut out of the Sand. Use the untextured summit below 32px or in one color. Do not add a lock or shield.
